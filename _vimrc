...
" When        Who           What
" --------------------------------------------------------------------------------------------------------------------------------------
" 06-02-2016 Menno Harzing  initial version
" 15-03-2016 Menno Harzing  added Tagbar and NERDTree
...
" --------------------------------------------------------------------------------------------------------------------------------------
" PL/SQL SETTINGS  in filetype.vim, for shared folder. activation in this file is not enough.
" --------------------------------------------------------------------------------------------------------------------------------------
...
nmap     <F9>        :call ToggleNERDTreeAndTagbar()<CR>
nnoremap <leader>\   :call ToggleNERDTreeAndTagbar()<CR>

colorscheme monzo1                                                              " color scheme
syntax enable                                                                   " syntax setting
" --------------------------------------------------------------------------------------------------------------------------------------
...
set nowrap                                                                      " no wrapping of lines at the end of the terminalblock
" --------------------------------------------------------------------------------------------------------------------------------------
if exists('+colorcolumn')                                                       " set right edge on page for Vim >= 7.3
    set textwidth=100
    set colorcolumn=+1
    hi ColorColumn ctermbg=grey guibg=grey
else                                                                            " set right edge on page for Vim < 7.3
...
set lazyredraw                                                                  " don't show refreshes of screen while running macros
set ruler                                                                       " Always show current positions along the bottom
" --------------------------------------------------------------------------------------------------------------------------------------
set laststatus=2                                                                " always show the status line
set statusline=%F%m%r%h%w[%{&ff}]%y[%p%%][L:%04l/%04L,C:%04v]                  " show a statusline
"              | | | | |    |       |       |    |       +-- current column
"              | | | | |    |       |       |    +-- total nr of lines
"              | | | | |    |       |       +-- current line
"              | | | | |    |       +-- current % into file
...
" TODO build in OS checker!
"let g:tagbar_ctags_bin='c:\bin\ctags\ctags.exe'
